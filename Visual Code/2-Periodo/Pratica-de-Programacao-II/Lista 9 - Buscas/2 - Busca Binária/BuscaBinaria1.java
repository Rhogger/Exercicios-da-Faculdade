...
public class BuscaBinaria1 {
  public static void main(String[] args) {
    ...
    int[] vetor1 = { 9, 75, 77, 18, 48, 14, 2, 4, 91, 57, 56, 29, 22, 5, 8, 60, 62, 93, 97, 7, 49, 87, 81, 71, 38, 78,
        99, 19, 31, 67 };
    int[] vetor2 = new int[31];
    int inicio = 0, meio, fim = vetor1.length - 1, i = 0, encontrou = -1, num;
    ...
    for (i = inicio; i <= fim; i++) {
      //No primeiro N° encontrado, ele incrementa a variavel "encontrou"
      if (i == inicio) {
        encontrou++;
      }

      //Aqui identifica e imprime o valor e sua posição
      if (encontrou != -1 && num == vetor1[i]) {
